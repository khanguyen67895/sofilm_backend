...
export class Migration1784273489041 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_9175e059b0a720536f7726a88c" ON "settings" ("userId") `,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."profiles_subscriptiontier_enum" AS ENUM('FREE', 'VIP', 'PREMIUM')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_315ecd98bd1a42dcf2ec4e2e98" ON "profiles" ("userId") `,
    );
    await queryRunner.query(
