...
export class Migration1784273561449 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."subscription_plans_tier_enum" AS ENUM('FREE', 'VIP', 'PREMIUM')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."user_subscriptions_status_enum" AS ENUM('ACTIVE', 'EXPIRED', 'CANCELED')`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_0641da02314913e28f6131310e" ON "user_subscriptions" ("user_id") `);
        ...
        await queryRunner.query(`CREATE TYPE "public"."invoices_status_enum" AS ENUM('PENDING', 'PAID', 'FAILED', 'REFUNDED')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."payments_provider_enum" AS ENUM('STRIPE', 'PAYPAL', 'VNPAY', 'MOMO', 'ZALOPAY')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."refunds_status_enum" AS ENUM('PENDING', 'COMPLETED', 'FAILED')`);
        ...
        await queryRunner.query(`ALTER TABLE "invoices" ADD CONSTRAINT "FK_08521b1e94fa456ac57f335485f" FOREIGN KEY ("plan_id") REFERENCES "subscription_plans"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "invoices" ADD CONSTRAINT "FK_235448f0474f16ab9b8a01b9973" FOREIGN KEY ("coupon_id") REFERENCES "coupons"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "invoices" DROP CONSTRAINT "FK_235448f0474f16ab9b8a01b9973"`);
